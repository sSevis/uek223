...
public class Product {
    ...
    public Product(UUID id, String description, float buyingPrice, float sellingPrice, Availability availability, User supplier, Set<ProductPurchase> productPurchases) {
        this.id = id;
